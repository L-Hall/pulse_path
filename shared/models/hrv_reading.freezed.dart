...
class _$HrvReadingImpl implements _HrvReading {
  ...
  @override
  String toString() {
    return 'HrvReading(id: $id, timestamp: $timestamp, durationSeconds: $durationSeconds, metrics: $metrics, rrIntervals: $rrIntervals, scores: $scores, notes: $notes, tags: $tags, isSynced: $isSynced)';
  }
...
abstract class _HrvReading implements HrvReading {
  const factory _HrvReading(
      ...
      final String? notes,
      final List<String>? tags,
      final bool isSynced}) = _$HrvReadingImpl;
